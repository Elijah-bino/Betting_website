...
<div class="content">
    <?php
        ...
        // Retrieve the user's username, image URL, and email from the session
        ...
        $userid = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : 0; // Replace with your actual session variable
    ?>
    ...
    <div class="table-box">
        <table class="styled-table">
            ...
            <?php
                // Fetch bets data for the logged-in user
                $sql = "SELECT bet_type, bet_chosen, bet_status, bet_ticket_amount, bet_ticket_amount_value, bet_result FROM bet WHERE user_id = ?";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td>" . $row["bet_type"] . "</td>";
                        echo "<td>" . $row["bet_chosen"] . "</td>";
                        echo "<td>" . $row["bet_status"] . "</td>";
                        echo "<td>" . $row["bet_ticket_amount"] . "</td>";
                        echo "<td>" . $row["bet_ticket_amount_value"] . "</td>";
                        echo "<td>" . $row["bet_result"] . "</td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='6'>No bets found</td></tr>";
                }
